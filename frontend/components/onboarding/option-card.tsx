...
export function OptionCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "group relative flex w-full h-full items-start gap-4 rounded-2xl border p-4 text-left transition-all duration-300 ease-out",
        selected
          ? "border-blue-600 bg-blue-50/50 shadow-md shadow-blue-500/10 ring-1 ring-blue-600 dark:border-blue-500 dark:bg-blue-500/10 dark:ring-blue-500"
