...
export const pl: Dictionary = {
  ...
  scheduledPosts: {
    ...
    subtitle: "Przeglądaj przyszłe publikacje i posty już wypuszczone do wysyłki w jednym miejscu.",
    emptyState: "Nie masz jeszcze żadnych zaplanowanych postów.",
    ...
    previewSubtitle: "Sprawdź pełną treść i docelowe konto przed wysłaniem publikacji.",
    ...
    cancelConfirm: "Anulować ten zaplanowany post? Nie zostanie wysłany.",
    characterCount: (count, limit) => `${count}/${limit} znaków`,
    platform: "Platforma",
    status: "Status",
    ...
    noDraft: "Brak nazwy szkicu",
    noAccount: "Brak nazwy konta",
    assetCount: (count) => `${count} ${count === 1 ? "asset" : count < 5 ? "assety" : "assetów"}`,
    queued: "W kolejce",
  ...
  studio: {
    ...
    publicationScheduled: "Publikacja na LinkedIn zaplanowana",
    publicationScheduledFor: (scheduledFor) => `Zaplanowano na ${scheduledFor}`,
    publicationCancelled: "Publikacja na LinkedIn anulowana",
    ...
    cancelScheduledPublication: "Anuluj termin",
    reschedulePublication: "Zmień termin",
    ...
    toasts: {
      ...
      publicationScheduled: "Publikacja na LinkedIn została zaplanowana.",
      publicationCancelled: "Publikacja na LinkedIn została anulowana.",
      publicationRescheduled: "Termin publikacji na LinkedIn został zmieniony.",
