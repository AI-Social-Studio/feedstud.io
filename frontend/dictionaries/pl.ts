...
export const pl: Dictionary = {
  ...
  profile: {
    title: "Profil AI",
    subtitle: "Zarządzaj kontekstem, którego Feedstudio używa podczas generowania treści.",
    reRunWizard: "Przejdź onboarding ponownie",
    savedToast: "Profil AI został zaktualizowany!",
    errorToast: "Nie udało się zapisać zmian w profilu AI.",
    emptyState: "Brak zapisanych danych.",
  },
  myCampaigns: {
    title: "Moje kampanie",
  ...
  studio: {
    ...
    moveAssetLater: "Później",
    assetAltTextLabel: "Alt text",
    assetAltTextPlaceholder: "Opisz obraz pod kątem dostępności",
    manageConnectedAccounts: "Zarządzaj połączonymi kontami",
    linkedinPublishTitle: "Publikacja na LinkedIn",
    linkedinConnectedAs: (accountName) => `Połączono jako ${accountName}`,
    linkedinDisconnected: "Brak połączonego konta LinkedIn.",
    publicationCompleted: "Opublikowano na LinkedIn",
    publicationFailed: "Publikacja na LinkedIn nie powiodła się",
    publicationInProgress: "Publikacja na LinkedIn trwa",
    publicationProcessingHint: "Worker backendu przetwarza tę publikację.",
    publicationHistory: "Historia publikacji",
    publicationHistoryEmpty: "Brak prób publikacji na LinkedIn dla tego szkicu.",
    retryPublication: "Ponów publikację",
    openOnLinkedIn: "Otwórz na LinkedIn",
    target: "Cel",
    ...
    toasts: {
      ...
      linkedinTooManyAssets: "LinkedIn obsługuje maksymalnie 20 obrazów na post.",
      linkedinReconnectRequired: "Połącz ponownie konto LinkedIn i spróbuj jeszcze raz.",
      linkedinRateLimited: "LinkedIn ograniczył liczbę żądań. Spróbuj ponownie za chwilę.",
