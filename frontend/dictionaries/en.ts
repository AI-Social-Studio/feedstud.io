...
export const en: Dictionary = {
  ...
  scheduledPosts: {
    ...
    subtitle: "Review upcoming scheduled and released-for-send posts in one place.",
    emptyState: "You do not have any scheduled posts yet.",
    errorState: "Failed to load scheduled posts right now.",
    successState: "Scheduled post cancelled.",
    updatedState: "Scheduled post updated.",
    rescheduledState: "Scheduled post rescheduled.",
    updatedAndRescheduledState: "Scheduled post updated and rescheduled.",
    preview: "Preview",
    previewLoading: "Loading preview...",
    previewTitle: "Scheduled post preview",
    previewSubtitle: "Review the full content and publishing target before the post is sent.",
    fullContent: "Full content",
    edit: "Edit",
    editTitle: "Edit scheduled post",
    editSubtitle: "Update the LinkedIn post text before it is sent.",
    editHelp: "Only the final publication text is editable in this step.",
    editScheduleHelp: "You can also adjust the send time while the publication is still scheduled.",
    editScheduleLocked:
      "Scheduled time can no longer be changed after the publication enters the queue.",
    editPlaceholder: "Enter LinkedIn post text",
    save: "Save",
    saving: "Saving...",
    cancel: "Cancel",
    cancelling: "Cancelling...",
    cancelConfirm: "Cancel this scheduled post? It will not be sent.",
    loadMore: "Load more",
    loadingMore: "Loading...",
    characterCount: (count, limit) => `${count}/${limit} characters`,
    platform: "Platform",
    status: "Status",
    ...
    noDraft: "No draft label",
    noAccount: "No account name",
  ...
  studio: {
    ...
    publicationCancelled: "LinkedIn publication cancelled",
    ...
    reschedulePublication: "Update schedule",
    ...
    toasts: {
      ...
      publicationCancelled: "LinkedIn publication cancelled.",
      publicationRescheduled: "LinkedIn publication rescheduled.",
